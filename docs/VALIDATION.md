...
### 2026-07-30 · V13 — M10 opened on four controls that could not have worked

Three of the four were found by *building the next layer down* rather than by reading, which is the pass's pattern: an alarm forced me to ask what publishes the metric, and the answer was "nothing, and the scrubber would have corrupted the name anyway".

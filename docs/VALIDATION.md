...
### 2026-07-30 · V13 — M10 opened on seven controls that could not have worked

Most of these were found by *building the next layer down* rather than by reading, which is the pass's pattern: an alarm forced me to ask what publishes the metric, and the answer was "nothing, and the scrubber would have corrupted the name anyway". The last two came from wiring the final pair of emitters, where the question "what number will this actually produce?" turned out to have an answer nobody had computed.
